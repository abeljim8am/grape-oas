...
- [#84](https://github.com/numbata/grape-oas/pull/84): Substitute the concrete path version into route templates when a route is mounted with `version "...", using: :path` - [@abeljim8am](https://github.com/abeljim8am).
* Your contribution here
